...
class TestTranslateCoordinates:
    ...
    #     QPointF(23.603663891906972, 69.34316402174204),
    #     QPointF(29.221275527271125, 51.47385742013856)
    # ])
    ...
    @pytest.mark.parametrize("lat_lng,xy", [
        (QPointF(41.85, -87.65), QPointF(65.67111111111112, 95.17492654697409),)
    ])
