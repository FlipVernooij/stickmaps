from PySide6.QtCore import QAbstractProxyModel, QAbstractItemModel, Signal
...
class SurveyCollection(QStandardItemModel):
    ...
    def load_model(self):
        ...
        for survey_row in survey_rows:
            survey = QStandardItem(QIcon(TREE_ICON_SURVEY), survey_row['survey_name'])
            ...
            for section_row in section_rows:
                section = QStandardItem(QIcon(TREE_ICON_SECTION), section_row['section_name'])
                ...
                for point_row in point_rows:
                    point = QStandardItem(QIcon(TREE_ICON_POINT), f"Point {point_row['point_reference_id']}")
